...
The web app uses Vitest for focused utility regression coverage:

```bash
npm run test
```

- Root tests cover attendance-log parsing and Firestore log DTO serialization.
...
No coverage threshold is configured today.
