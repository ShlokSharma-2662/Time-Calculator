...
async function loadSettings() {
  ...
  usernameEl.value = data.spineUsername || '';
  passwordEl.value = data.spinePassword || '';
  saveCredsEl.checked = Boolean(data.spineSaveCredentials);
...
btnSaveCreds.addEventListener('click', async () => {
  const save = saveCredsEl.checked;
